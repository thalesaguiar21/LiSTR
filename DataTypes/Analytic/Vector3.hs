...
origin (Vector3 (i, j, k, l, m, n)) = Vector3 (0, 0, 0, l-i, m-j, n-k)
...
norm :: Vector3 -> Float
norm v = let Vector3 (_, _, _, x, y, z) = origin v
         in sqrt (x^2 + y^2 + z^2)
...
v1 >< v2 = let Vector3 (xi1, yi1, zi1, x1, y1, z1) = origin v1
               Vector3 (xi2, yi2, zi2, x2, y2, z2) = origin v2
